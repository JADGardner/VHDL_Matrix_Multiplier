...
HD_PWD='M:/VivadoProjects/Final_Project/Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Matrix_Multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Matrix_Multiplier.tcl
